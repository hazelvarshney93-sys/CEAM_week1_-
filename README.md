...
The photos were taken in different lightning conditions, different locations and different angles in order for our machine learning model to be as
efficient as poosible.
